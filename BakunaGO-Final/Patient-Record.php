...
<head>
    ...
    <style type="text/css" media="print">
      @media print{
        .accordion, .accordion, .action, .action, .view, .view, .dlt, .dlt, .edit, .edit, .prntbtn, .prntbtn *{
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                   ...
                   <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Patient Information Record</h1>
                    </div>
 
                    <!-- DITO KA MAGLAGAY IDOL -->
                     <button class="btn btn-primary prntbtn" onclick="window.print()">Print <i class="fa fa-print"></i></button>
      ...
      ?>
        ...
        <tr style="color: black;">
          ...
          <td>
            ...
            <a href="View-Patient-Record.php?view=<?php echo $row['id']; ?>" class ="btn btn-primary view"><i class="fa fa-eye"></i></a>
            <a href="Edit-Patient-Record.php?update=<?php echo $row['id']; ?>" class ="btn btn-success edit"><i class="fa fa-edit"></i></a>
            <a href="delete.php?delete=<?php echo $row['id']; ?>" class="btn btn-danger dlt" onclick="return confirm_delete()"><i class="fa fa-trash"></i></a>
          </td>
        </tr>      
      <?php
    }
...
<?php 
 ...
 <script>
  function confirm_delete(){
    return confirm("WOULD YOU LIKE TO DELETE THIS PATIENT?");
  }
</script>