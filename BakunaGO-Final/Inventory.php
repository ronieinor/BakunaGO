            ...
            <div id="content">
                ...
                <div class="container-fluid">
                     ...
                     <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Vaccine Inventory Monitoring</h1>
                    </div>
...
<!-- ######################ADD MODAL ################################# -->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add Vaccine Stocks</h5>
      ...
      <div class="modal-body">
        ...
        <form action="Add-Inventory.php" method="POST">
          ...
          <div class="form-group">
            ...
            <select class="custom-select" id="measurement" name="measurement">
          ...
          <div class="form-group">
            ...
            <input type="date" name="expiry" class="form-control" placeholder="Expiration Date">
          </div>
  ...
  <div class="rounded p-2 m-4" style="background-color: white">
    <br>
<h2 style="color: black; text-align: center;">I N V E N T O R Y &nbsp; R E P O R T</h2>
<button class="btn btn-success" onclick="window.location.replace('Inventory-Report.php')">Inventory Report <i class="fa fa-print"></i></button>
 <button type="button" class="btn btn-info" data-toggle="modal" data-target="#addinventoryModal">
  Add Vaccine Stock <i class="fa fa-plus"></i>
</button>
...
<?php
  ...
  $stmt = $DB_con->prepare('SELECT * FROM inventory');
  $stmt->execute();
  ...
  if($stmt->rowCount() > 0){
    while($row=$stmt->fetch(PDO::FETCH_ASSOC)){
      ?>
        ...
        <tr style="color: black;">
          ...
          <td><?php echo '<span class="badge badge-success">In-Stock</span>';?></td>
          <td> 
            <a href="Update-Inventory-Record.php?update=<?php echo $row['id']; ?>" class ="btn btn-success"><i class="fa fa-edit"></i></a>
            <a href="delete_inventory.php?delete=<?php echo $row['id']; ?>" class="btn btn-danger" onclick="return confirm_delete()"><i class="fa fa-trash"></i></a>
          </td>
    ...
    ?>
        <tr style="color: black;">
          ...
          <td> </td>
          <td> </td>
          <td class=" text-center text-danger" style="font-family: tahoma; font-size: 20px; background-color: "> <?php echo 'No Stock Record'?> </td>
          <td> </td>
          <td> </td>
          <td> </td>
...
<script>
  function confirm_delete(){
    return confirm("WOULD YOU LIKE TO DELETE THIS VACCINE?");
  }
</script>
