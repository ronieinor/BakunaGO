  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title" id="exampleModalLabel">Add Admin Account</h3>
      ...
      <div class="modal-body">
        ...
        <form action="add-admin-function.php" method="POST">
          
          <h5 style="color: grey;">Admin Information</h5>
         ...
         <div class="row">
           ...
           <label style="color: grey;">Permanent Address:</label>
            <div class="row">
             <div class="col">
             ...
             <div class="col">
              <input type="text" class="form-control" id="city" placeholder="City/Town" name="city" required>
            </div>
        ...
        <label style="color: grey;">Other Information:</label>
        ...
        <div class="row">
             ...
             <div class="col">
              <input type="DATE" class="form-control" id="bday" placeholder="bday" name="bday" required>
            </div>
        </div><br>
        ...
        <label style="color: grey;">Admin Account:</label>
        ...
        <button type="submit" name="Add" class="btn btn-primary">Submit</button>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Admin Record</h1>
                    </div>

        <!-- Adding Admin Form --> 
  <div class="rounded p-2 m-4" style="background-color: white">
    <br>
    <button type="button" class="btn btn-info" data-toggle="modal" data-target="#addAdminModal">
  Add Administrator <i class="fa fa-plus"></i>
</button>
    <br><br>
...
<?php
  ...
  $stmt = $DB_con->prepare('SELECT * FROM admin_record');
  $stmt->execute();
    ...
    while($row=$stmt->fetch(PDO::FETCH_ASSOC)){
      ?>
        ...
        <tr style="color: black;">
          ...
          <td><?php echo $row['barangay']; ?>, <?php echo $row['city']; ?> </td>
          <td><?php echo $row['phone']; ?></td>
          <td>
            
            <a href="View_Admin.php?view=<?php echo $row['id']; ?>" class ="btn btn-primary"><i class="fa fa-eye"></i></a>
            <a href="Update_Admin.php?update=<?php echo $row['id']; ?>" class ="btn btn-success"><i class="fa fa-edit"></i></a>
            <a href="delete_admin.php?delete=<?php echo $row['id']; ?>" class="btn btn-danger" onclick="return confirm_delete()"><i class="fa fa-trash"></i></a>
          </td>
        </tr>      
      <?php
    }
...
<script>
  function confirm_delete(){
    return confirm("WOULD YOU LIKE TO DELETE THIS ADMIN?");
  }
</script>
