...
<head>
    ...
    <title>Adding Admin Account</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                   ...
                   <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Adding Admin Account</h1>
                    </div>

        <!-- Adding Admin Form --> 

                    <div class="container rounded-oval">
        
          <form action="Add-Admin.php" method="POST" class="p-3  text-light">
            <h4 style="color: grey;">Admin Information</h4>
